...
namespace ZentCloud.BLLJIMP.Model
{
    ...
    /// 系统设置
    /// </summary>
    public class SystemSet : ZCBLLEngine.ModelTable
    {
        #region Model
        private int _autoid;
        ...
        /// 系统短信用户ID
        /// </summary>
        public string SysSmsUserID { get; set; }
        /// <summary>
        /// 系统短信用户密码
        /// </summary>
        public string SysSmsUserPwd { get; set; }
        /// <summary>
        /// 短信平台API
        /// </summary>
        public string SysSmsApi { get; set; }

        public string SysTriggerSmsUserID { get; set; }

        public string SysTriggerSmsUserPwd { get; set; }

        /// <summary>
        /// 微信开放平台 component_verify_ticket
        /// </summary>
        ...
        /// <summary>
        /// 组件AccessToken 最后更新时间
        /// </summary>
        public DateTime? ComponentAccessTokenUpdateTime { get; set; }
