...
namespace Payment.WeiXin
{
    public class WxPayHelper
    {
        ...
        public string GetCftPackage()
        {
            ...
            string unSignParaString = Payment.WeiXin.CommonUtil.FormatBizQueryParaMap(parameters,
                    false);
            string paraString = Payment.WeiXin.CommonUtil.FormatBizQueryParaMap(parameters, true);
            return paraString + "&sign="
                    + Payment.WeiXin.MD5SignUtil.Sign(unSignParaString, PartnerKey);
        ...
        public string GetBizSign(Dictionary<string, string> bizObj)
        {
            ...
            string bizString = Payment.WeiXin.CommonUtil.FormatBizQueryParaMap(bizParameters, false);

            return Payment.WeiXin.SHA1Util.Sha1(bizString);
        ...
        public string CreateAppPackage(string traceid)
        {
            ...
            nativeObj.Add("noncestr", Payment.WeiXin.CommonUtil.CreateNoncestr());
        ...
        public string CreateNativeUrl(string productid)
        {
            ...
            try
            {
                ...
                bizString = Payment.WeiXin.CommonUtil.FormatBizQueryParaMap(nativeObj, false);
        ...
        public string CreateNativePackage(string retcode, string reterrmsg)
        {
            ...
            return Payment.WeiXin.CommonUtil.ArrayToXml(nativeObj);
