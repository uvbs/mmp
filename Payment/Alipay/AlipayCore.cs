...
namespace Payment.Alipay
{
    ...
    public class Core
    {
        ...
        public static string CreateLinkString(Dictionary<string, string> dicArray, string includeBy = "")
        {
            StringBuilder sb = new StringBuilder();
            foreach (KeyValuePair<string, string> temp in dicArray)
            {
                sb.Append(temp.Key + "=" + includeBy + temp.Value + includeBy + "&");
            }
        ...
        public static string CreateLinkStringUrlencode(Dictionary<string, string> dicArray, Encoding code)
        {
            ...
            foreach (KeyValuePair<string, string> temp in dicArray)
            {
                sb.Append(temp.Key + "=" + HttpUtility.UrlEncode(temp.Value, code) + "&");
            }
        ...
        public static string GetAbstractToMD5(Stream stream)
        {
