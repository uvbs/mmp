...
{
    public partial class NotifyOrderPay : System.Web.UI.Page
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                xmlDoc.Save(string.Format("C:\\WXPay\\OrderPayNotify{0}.xml", DateTime.Now.ToString("yyyyMMddHHmmssfff")));//写入日志
