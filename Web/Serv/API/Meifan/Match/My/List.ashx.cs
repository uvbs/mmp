...
namespace ZentCloud.JubitIMP.Web.Serv.API.Meifan.Match.My
{
    /// <summary>
    /// List 的摘要说明
    /// </summary>
    public class List : BaseHandlerNeedLoginNoAction
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int totalCount;
            var data = bll.ActivityDataList(pageIndex, pageSize, out totalCount, "", CurrentUserInfo.UserID, "match");
            ...
            foreach (var item in data)
            {
                ...
                model.status = bll.GetMyMatchStatus(activity,CurrentUserInfo);
                list.Add(model);
            }
