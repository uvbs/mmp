...
namespace ZentCloud.JubitIMP.Web.Serv.API.Admin.Article
{
    ...
    public class Update : BaseHandlerNeedLoginAdminNoAction
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            BLLJIMP.Model.JuActivityInfo model = bllJuActivity.GetJuActivity(requestModel.article_id, false);
            if (model == null)
            {
            ...
            model.ArticleTypeEx1 = bllJuActivity.GetCurrUserID() + "_" + bllJuActivity.WebsiteOwner;
