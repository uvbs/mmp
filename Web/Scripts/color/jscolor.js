...
var jscolor = {
	...
	getDir : function() {
		if(!jscolor.dir) {
			...
			jscolor.dir = detected !== false ? detected : '/Scripts/color/';
		}
		return jscolor.dir;
	},
	detectDir : function() {
	...
	color: function (target, prop) {
	    this.canNull = true;//可以为空
	    this.selectedColor = false;//是否已选颜色
		...
		this.exportColor = function (flags) {
		    if (this.canNull && !this.selectedColor && valueElement.value == '') {
		        return;
		    }
