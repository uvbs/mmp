<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWXPositionList.aspx.cs"
    Inherits="ZentCloud.JubitIMP.Web.WuBuHui.Position.MyWXPositionList" %>
...
<body>
    ...
    <div class="paixu">
        <div class="col-xs-4">
            <a href="#" class="wlink current" v="ptiem">最新发布</a>
        </div>
        <div class="col-xs-4">
            <a href="#" class="wlink" v="ppv">最多阅读</a>
        </div>
    ...
    <div class="footerbar">
        <div class="col-xs-2 ">
            <a class="wbtn wbtn_main" type="button" href="javascript:pagegoback('../MyCenter/Index.aspx')"><span class="iconfont icon-back">
            </span></a>
        </div>
        <!-- /.col-lg-2 -->
        <div class="col-xs-8">
            <a href="../Position/WXPositionList.aspx" class="wbtn wbtn_line_main" id="askthisteacher">
                <span class="iconfont icon-39 smallicon"></span>全部职位</a>
        </div>
        <!-- /.col-lg-10 -->
                <div class="col-xs-2 ">
...
<script>
    ...
    function InitData() {
        $.ajax({
            ...
            data: { Action: "GetPositiInfoList", PageIndex: PageIndex, PageSize: PageSize, Title: title, My: "my", Sort: px, TradeIds: TradeIds, ProfessionalIds: ProfessionalIds },
            dataType:'json',
