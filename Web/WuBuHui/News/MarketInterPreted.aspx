<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarketInterPreted.aspx.cs"
    Inherits="ZentCloud.JubitIMP.Web.WuBuHui.News.MarketInterPreted" %>
...
<body>
    <div class="behindbar">
        <div class="title wbtn_line_greenyellow">
            <span class="iconfont icon-78"></span>市场解读
        </div>
        <ul class="catlist">
    ...
    <div class="mainlist top50 bottom50" id="needload">
        <div class="tagbar">
            <a href="MarketNews.aspx" class="wbtn " id="newslistbtn"><span class="iconfont icon-78">
            </span><span class="title">市场新闻</span> </a><a href="#" class="wbtn wbtn_greenyellow"
                id="discusslistbtn"><span class="iconfont icon-78"></span><span class="title">市场解读</span>
            </a>
        </div>
        <div id="objList">
        </div>
...
<script type="text/javascript" src="../js/footer.js"></script>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="alertbox">
        <div class="modal-dialog">
	        ...
	        <h4 class="modal-title">Modal title</h4>
                ...
                <div class="modal-footer textcenter">
                    <span class="wbtn wbtn_main" data-dismiss="modal">确定</span>
...
<script type="text/javascript">
     ...
     var RootCategoryID = "<%=MarketInterPretedids%>"; //总分类
     ...
     function LoadList() {
         $.ajax({
             ...
             success: function (resp) {
                 ...
                 if (resp.ExObj == null) { $(".loadnote").text("没有更多"); return; }
                 var listHtml = '';
                 ...
                 for (var i = 0; i < resp.ExObj.length; i++) {
                     ...
                     str.AppendFormat('<div class="touxiang wbtn_round" ><img src="{0}" alt="" /></div>', resp.ExObj[i].ThumbnailsPath);
