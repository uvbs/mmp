<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="WXPartnerMgr.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.WuBuHui.WebAdmin.WXPartnerMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
            ...
            $('#grvData').datagrid(
	            {
	                method: "Post",
	                url: handlerUrl,
	                queryParams: { Action: "GetPartnerInfos" },
	                ...
	                columns: [[
                                ...
                                { field: 'PartnerName', title: '名称', width: 10, align: 'left' },
                                { field: 'PartnerImg', title: 'Logo', width: 10, align: 'left', formatter: function (value) {
                                    if (value == '' || value == null)
                                        return "";
                                ...
                                { field: 'PartnerAddress', title: '地址', width: 10, align: 'left' },
                                { field: 'PartnerPv', title: '浏览量', width: 10, align: 'left' },
                                { field: 'ParTnerStep', title: '赞', width: 10, align: 'left' },
            ...
            $.messager.confirm("系统提示", "确定删除选中?", function (o) {
                if (o) {
                    $.ajax({
                        type: "Post",
                        url: handlerUrl,
                        data: { Action: "DelPartnerInfo", ids: GetRowsIds(rows).join(',') },
        ...
        function OnEdit() {
            ...
            window.location.href = "WXPartnerAU.aspx?AutoId=" + GetRowsIds(rows).join(',');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;管理&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>五伴会</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        <div style="margin-bottom: 5px">
            <a href="WXPartnerAU.aspx" class="easyui-linkbutton" iconcls="icon-add2" plain="true">
