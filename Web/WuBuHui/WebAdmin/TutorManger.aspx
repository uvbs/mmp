<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="TutorManger.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.WuBuHui.WebAdmin.TutorManger" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
            ...
            $('#grvData').datagrid(
	            {
	                ...
	                columns: [[
                                ...
                                { field: 'TutorName', title: '导师名称', width: 10, align: 'left' },
                                { field: 'TutorImg', title: '导师照片', width: 10, align: 'left', formatter: function (value) {
                                    if (value == '' || value == null)
                                        return "";
                                ...
                                { field: 'City', title: '城市', width: 10, align: 'left' },
                                { field: 'TutorAnswers', title: '问题数', width: 10, align: 'left' },
                                { field: 'TutorQuestions', title: '回答数', width: 10, align: 'left' },
                                { field: 'RDataTime', title: '创建时间', width: 20, align: 'left', formatter: FormatDate },
                             ]]
	            }
            );
        });
        ...
        function OnEdit() {
            ...
            window.location.href = "WXTutorInfo.aspx?AutoId=" + GetRowsIds(rows).join(',');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;管理&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>导师管理</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        <div style="margin-bottom: 5px">
            <a href="WXTutorInfo.aspx" class="easyui-linkbutton" iconcls="icon-add2" plain="true">
