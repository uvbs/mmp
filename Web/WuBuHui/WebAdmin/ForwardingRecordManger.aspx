<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="ForwardingRecordManger.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.WuBuHui.WebAdmin.ForwardingRecordManger" %>
            ...
            $('#grvData').datagrid(
	            {
	                method: "Post",
	                url: handlerUrl,
	                queryParams: { Action: "GetForwardingRecordInfos" },
	                ...
	                columns: [[
                                ...
                                { field: 'RUserName', title: '注册人', width: 10, align: 'left' },
                                { field: 'FuserName', title: '转发人', width: 10, align: 'left' },
                                { field: 'TypeName', title: '类别名称', width: 10, align: 'left' },
                                { field: 'RdateTime', title: '创建时间', width: 20, align: 'left', formatter: FormatDate },
                             ]]
	            }
            );
        });
            ...
            $.messager.confirm("系统提示", "确定删除选中?", function (o) {
                if (o) {
                    $.ajax({
                        type: "Post",
                        url: handlerUrl,
                        data: { Action: "DelFRecordInfo", ids: GetRowsIds(rows).join(',') },
