<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="WXWBHBannaImg.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.WuBuHui.WebAdmin.WXWBHBannaImg" %>
            ...
            $('#grvData').datagrid(
	            {
	                method: "Post",
	                url: handlerUrl,
	                queryParams: { Action: "GetBannerInfos" },
	                ...
	                columns: [[
                                ...
                                { field: 'BannaName', title: '名称', width: 10, align: 'left' },
                                { field: 'BannaImg', title: 'banner', width: 10, align: 'left', formatter: function (value) {
                                    if (value == '' || value == null)
                                        return "";
                                ...
                                { field: 'BannaUrl', title: '地址', width: 10, align: 'left' },
            ...
            $.messager.confirm("系统提示", "确定删除选中?", function (o) {
                if (o) {
                    $.ajax({
                        type: "Post",
                        url: handlerUrl,
                        data: { Action: "DelBannerInfo", ids: GetRowsIds(rows).join(',') },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;管理&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>banner图</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        <div style="margin-bottom: 5px">
            <a href="WXWBHBannaImgInfo.aspx" class="easyui-linkbutton" iconcls="icon-add2" plain="true">
