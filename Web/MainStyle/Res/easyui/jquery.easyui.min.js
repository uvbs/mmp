...
$.fn.pagination.defaults = {
    total: 1, pageSize: 10, pageNumber: 1, pageList: [
        50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_8b, _8c) {
...
if ($(_59e)[0]) $(_59e)[0].innerHTML = _5a2.join("");
//$(_59e).html(_5a2.join(""));
...
if ($(_5a7)[0]) $(_5a7)[0].innerHTML = _5aa.join("");
//$(_5a7).html(_5aa.join(""));
...
//$(_5fb).html(_5ff.join(""));
if ($(_5fb)[0]) $(_5fb)[0].innerHTML = _5ff.join("");
...
//$(_6a9).html(_6ac.join(""));
if ($(_6a9)[0]) $(_6a9)[0].innerHTML = _6ac.join("");
