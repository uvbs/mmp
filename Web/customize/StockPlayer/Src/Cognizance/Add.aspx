<%@ Page Title="" Language="C#" MasterPageFile="~/customize/StockPlayer/StockPlayerSite.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.customize.StockPlayer.Src.Cognizance.Add" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <link href="/customize/StockPlayer/Src/Cognizance/Add.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBodyCenter" runat="server">
    <div class="warp-add">
        <div class="row content">
                ...
                <div class="col-xs-3 dTip"><span class="lbTip" style="display:none;" data-tip-msg="<b>投诉建议说明</b><br>1.后台审核通过将获取淘股币奖励；<br>2.12小时内到账，详情可咨询客服；<br/>谢谢您的理解和支持！">?</span></div>
           
                <div class="col-xs-3 textRight">
                    <label class="control-label title">内容：</label></div>
                <div class="col-xs-9 body-content">
                    <script id="cognizance"  type="text/plain">
                    </script>
                </div>
        </div>
         <div class="button">
...
<asp:Content ID="Content3" ContentPlaceHolderID="buttom" runat="server">
    ...
    <script type="text/javascript" src="/lib/ueditor/ueditor.all.min.js"> </script>
     <script type="text/javascript" src="/customize/StockPlayer/Src/Cognizance/Add.js"></script>
</asp:Content>
