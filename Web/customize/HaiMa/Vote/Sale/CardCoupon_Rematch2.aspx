<%@ Page Title="" Language="C#" MasterPageFile="~/customize/HaiMa/Vote/Sale/Master.Master"
    AutoEventWireup="true" CodeBehind="CardCoupon_Rematch2.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.customize.HaiMa.Vote.Sale.CardCoupon_Rematch2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="wrapUserCenter mBottom48">
        <div class="header">
            <img src="images/yaoqing2.jpg?v=1.1" />
        </div>
        <div class="wrapInput">
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <div class="inputControl">
                        <label>
                            <span>出发日期：</span>
                            <input type="text" value="2015年8月27日" readonly="readonly">
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="inputControl">
                        <label>
                            <span>返回日期：</span>
                            <input type="text" value="2015年8月31日" readonly="readonly">
                        </label>
                    </div>
                </div>
            </div>
