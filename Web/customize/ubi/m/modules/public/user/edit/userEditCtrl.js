ubimodule.controller('userEditCtrl', ['$scope', 'commService', 'userService', 'commArticle', 'ngDialog', function ($scope, commService, userService, commArticle, ngDialog) {
    ...
    pageFunc.init = function () {
        //userService.getUserInfo(pageData.currUser.id, function (data) {
