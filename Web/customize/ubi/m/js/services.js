ubimodule.factory('commService', ['$http', '$rootScope', '$location', '$anchorScroll','$sce', function($http, $rootScope, $location, $anchorScroll,$sce) {
 ...
 * @return {[type]}   [description]
 */
ubimodule.factory('datePickerCore', function() {
    var DatePicker = {};
...
ubimodule.factory('commActivity', ['$http', 'commService', function($http, commService) {
...
ubimodule.factory('commArticle', ['$http', 'commService', '$sce', function($http, commService, $sce) {
     ...
     * @return {[type]}              [description]
     */
    commArticle.getHotTags = function(callBack, failCallBack, cateId) {
        var reqData = {
            action: 'getTags',
            cateid: cateId,
            num: 30
     ...
     * @return {[type]}              [description]
     */
    commArticle.getTags = function(callBack, failCallBack, cateId, num) {
        var reqData = {
            action: 'getTags',
            cateid: cateId,
            num: num
     ...
     * @return {[type]}              [description]
     */
    commArticle.buyClass = function (articleId, callBack, failCallBack) {
        var reqData = {
...
ubimodule.factory('userService', ['$http', 'commService', '$sce', function($http, commService, $sce) {
    var userService = {};
    ...
    */
    ...
    userService.ShareAddScore = function (callBack,type) {
        var reqData = {
            action: 'ShareAddScore',
            type: type
        };
        commService.loadRemoteData(baseData.handlerUrl, reqData, function (data) {
            callBack(data);
    ...
    userService.getWeixinJSAPIPreOrder = function (option, callBack, failCallBack) {
        var reqData = {
            action: 'getWeixinJSAPIPreOrder'
        };
        commService.extend(reqData, option);
        commService.postData(baseData.handlerUrl, reqData, function (data) {
            callBack(data);
 ...
 * @return {[obj]} [模块对象]
 */
// ubimodule.factory('cateService', ['commService',
