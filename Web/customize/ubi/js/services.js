ubimodule.factory('commService', ['$http', '$rootScope', '$modal', '$location', '$anchorScroll', function ($http, $rootScope, $modal, $location, $anchorScroll) {
 ...
 */
 ...
 ubimodule.factory('carService', ['commService',
     function (commService) {
         var carService = {};
