    ...
    var Editor = function (context) {
        ...
        this.insertImagesOrCallback = function (files) {
            ...
            for (var i = 0; i < files.length; i++) {
                this.uploadZoomImg(files[i], 800, 0,
                    ...
                    function (complete) { //complete
                        ...
                        if (resp.errcode == 0 && resp.file_url_list && resp.file_url_list.length > 0) {
                            _this.insertImage(resp.file_url_list[0], resp.other_info_list[0].old_name);
                        } else {
                            context.triggerEvent('image.upload.error');
                        }
                    },
        ...
        this.uploadZoomImg = function (file, maxWidth, maxHeight, progress, complete, error) {
            ...
            fReader.onload = function (e) {
                ...
                img.onload = function () {
                    ...
                    fd.append("file1", blob, file.name);
    ...
    var VideoDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = '<div class="form-group row-fluid">' +
                ...
                '<textarea class="note-video-url" style="width: 100% !important;padding: 5px;min-height: 95px;line-height: 20px;border: 1px solid rgb(180, 180, 180);"></textarea>' +
                '</div>';
