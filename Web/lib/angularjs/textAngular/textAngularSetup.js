...
.value('taTranslations', {
	...
	underline: {
		tooltip: '下划线',//'Underline'
	},
	strikeThrough:{
		tooltip: '删除线',//'Strikethrough'
	},
	justifyLeft: {
		tooltip: '左对齐',//'Align text left'
	},
	justifyRight: {
		tooltip: '右对齐',//'Align text right'
	},
	justifyCenter: {
		tooltip: '居中对齐',//'Center'
	},
	...
	insertLink: {
		tooltip: '插入链接地址',//'Insert / edit link',
		dialogPrompt: "请输入链接地址"
	},
	editLink: {
		reLinkButton: {
			tooltip: "Relink"
