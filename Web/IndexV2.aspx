...
<body>
    ...
    <div class="header  <%=websiteInfo.IsHideAdminLogoAndTop == 1? "hidden":""%>">
        <div class="logov1">
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            setTimeout(function () {
                ...
                if ($('#side-menu>li').length < 5) {
                    $('#side-menu li ').first().addClass('active');
                    $('#side-menu li ul').first().addClass('in');
                }
        ...
        function BuySaas() {
            //自定页
            layer.alert('请拨打电话 021-60960775  联系客服续费')
        }
