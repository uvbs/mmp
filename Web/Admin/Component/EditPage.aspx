<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Component.EditPage" %>
...
<head runat="server">
    ...
    <%--扩展组件样式--%>
    <link href="/customize/comeoncloud/m2/dist/all.min.css?v=2017042401" rel="stylesheet" />
    <link href="/Plugins/angular/zcShop/zcShop.css?v=2017041201" rel="stylesheet" />
    <link href="/Plugins/angular/zcSelectLink/zcSelectLink.css?v=2017041201" rel="stylesheet" />
    <link href="/admin/component/css/app_simulate.css?v=2017041201" rel="stylesheet" />
    <link href="/admin/component/css/shop_drag.css?v=2017041201" rel="stylesheet" />
...
<body>
    <div class="editBody" ng-app="editComponentModule"
        ...
        <div class="qrcode" style="display: none;">
            <p>微信“扫一扫”浏览</p>
            <img class="qrcodeImg" width="140" height="140">
        ...
        <table class="component-table">
            <tr>
                <td class="left-col">
                        ...
                        <table class="form-table">
                            ...
                            <tr class="marginTop">
                                <td class="tdComponentModelButton draglist">
                                    ...
                                    <div class="dragsingle" ng-click="vmFunc.selectRightControl(2)">
                                        <div ng-bind-html="'icon-mulu'|FormatterIcon">
                                        </div>
                                        <span>高级选项</span>
                                    </div>
                    ...
                    <div class="submitDiv">
                        <button class="button button-calm" ng-click="vmFunc.selectTemplateDialog(1)">选择模板</button>
                        <%if (canSaveTemp)
                          {%>
                        <button class="button button-calm" ng-click="vmFunc.saveTemplateDialog()">存为模板</button>
                        <%}%>
                        <button class="button button-calm" ng-click="vmFunc.submitConfig()">保存</button>
                        <%if (backlist == "1")
                          {%>
                                        ...
                                        <div class="app-entry">
                                            ...
                                            <div class="js-fields-region" style="{{vmFunc.getPageBg(vm.only_contorls.pageinfo.bg_img,vm.only_contorls.pageinfo.bg_img_style,vm.only_contorls.pageinfo.bg_color)}}">
                                                <div class="app-fields headerbarBgPosition" ng-if="vm.only_contorls.headerbar" control-id="{{vm.only_contorls.headerbar.control_id}}">
                                                    <div class="app-field clearfix" ng-class="{ 'editing':vm.only_contorls.headerbar.selected}"
                                                        ng-click="vmFunc.selectRightControl(vm.only_contorls.headerbar)">
                                                ...
                                                <div class="app-fields ui-sortable">
                                                    <div class="app-field clearfix" ng-class="{ 'editing':control.selected}" control-id="{{control.control_id}}"
                                                        ...
                                                        <div class="control-group" ng-switch="control.control">
                                                            <headsearch ng-switch-when="headsearch"></headsearch>
                                                            ...
                                                            <goods key="{{control.control_id}}" ng-switch-when="goods" ng-if="control.config.good_list && control.config.good_list.length>0"></goods>
                ...
                <td class="right-col">
                    <div class="right-inner">
                        <div ng-if="vm.show_page_set">
                            <div class="form-div">
                                ...
                                <table class="form-table">
                                    <tr>
                                        <td class="form_td">
                                            <label class="shop_name">页面名称<span class="color_error">*</span>：</label>
                                            <div class="shop_choose">
                                                <input class="shop_text" type="text" ng-model="vm.component.ComponentName" placeholder="页面名称(必填)" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form_td">
                                            <label class="shop_name">页面标题<span class="color_error">*</span>：</label>
                                            <div class="shop_choose">
                                    ...
                                    <tr>
                                        <td class="picture">
                                            ...
                                            <%--<div class="pic_choose imgnav-info">
                                            <div class="formitems">
                                                <label class="fi-name">或直接输入地址上传：</label>
                                                <div class="form-controls">
                                                    <input type="text" class="xlarge" placeholder="直接输入背景图片地址" ng-model="vm.only_contorls.pageinfo.bg_img" />
                                                </div>
                                            </div>
                                        </div>--%>
                                            <div class="pic_choose imgnav-info">
                                    ...
                                    <tr>
                                        <td class="picture">
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">分享标题<span class="color_error">*</span>：</label>
                                                    <div class="form-controls">
                                                        <input type="text" class="xlarge" ng-model="vm.only_contorls.shareinfo.title" placeholder="分享标题" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">分享描述<span class="color_error">*</span>：</label>
                                                    <div class="form-controls">
                                                        <input type="text" class="xlarge" ng-model="vm.only_contorls.shareinfo.desc" placeholder="分享描述" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">点击上传分享图片<span class="color_error">*</span>：</label>
                                                    <div class="form-controls">
                                                        <img alt="分享图片" ng-src="{{vm.only_contorls.shareinfo.img_url}}" class="imgUpload imgnav shareImg" onerror="this.removeAttribute('src')" />
                                                        <input type="file" name="file1" class="file" style="display: none;" data-model="vm.only_contorls.shareinfo.img_url" />
                                                    </div>
                                                </div>
                                            </div>
                                            <%--<div class="pic_choose imgnav-info">
                                            <div class="formitems">
                                                <label class="fi-name">或直接输入地址上传：</label>
                                                <div class="form-controls">
                                                    <input type="text" class="xlarge" placeholder="直接输入分享图片地址" ng-model="vm.only_contorls.shareinfo.img_url" />
                                                </div>
                                            </div>
                                        </div>--%>
                                        </td>
                        ...
                        <div ng-if="vm.show_more_option">
                            <div class="form-div">
                                <%--<i class="icon iconfont icon-shixinjiantouzuo arrowleft"></i>--%>
                                <table class="form-table">
                                    <tr>
                                        <td class="shareset" style="padding-top: 0px;">高级选项
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="picture">
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">页面标识：</label>
                                                    <div class="form-controls">
                                                        <input type="text" class="xlarge" ng-model="vm.component.ComponentKey" placeholder="页面标识(选填，唯一)" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">微信授权：</label>
                                                    <div class="form-controls">
                                                        <label class="shop_label" for="chkIsWXSeniorOAuth">
                                                            <input id="chkIsWXSeniorOAuth" type="checkbox" ng-model="vm.component.IsWXSeniorOAuth" class="positionTop2">
                                                            <span>微信高级授权</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">访问级别：</label>
                                                    <div class="form-controls">
                                                        <input type="text" class="xlarge" ng-model="vm.component.AccessLevel" placeholder="访问级别(选填)" onkeyup="value=value.replace(/[^\d]/g,'')" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">分享链接：</label>
                                                    <div class="form-controls">
                                                        <input type="text" class="xlarge" png-model="vm.only_contorls.shareinfo.link" placeholder="链接(不填为当前链接)" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pic_choose imgnav-info">
                                                <div class="formitems">
                                                    <label class="fi-name">初始化数据：</label>
                                                    <div class="form-controls">
                                                        <label class="shop_label" for="chkIsInitData">
                                                            <input id="chkIsInitData" type="checkbox" ng-model="vm.component.IsInitData" class="positionTop2" />
                                                            <span>页面呈现前先查询出数据</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div ng-repeat="control in vm.cur_select_controls">
                            <div class="form-div" ng-class="{'m-top':$index>0}">
                                ...
                                <table class="form-table" ng-if="control.type>=4 && control.type!=7 && control.type!=8 && control.control!='content'">
                                    <tr ng-repeat="attr in control.attrs">
                                        <td class="form_td">
                                            <div ng-if="!(control.control=='headerbar' && attr.key=='left_btn' && control.config.sidemenu_button == '1')" >
                                                ...
                                                <div class="shop_choose" ng-if="attr.type==0 && control.control =='headsearch' && (attr.key=='nav_left' || attr.key=='nav_right') ">
                                                    <div class="radio-group" ng-if="control.control =='headsearch'&&vm.toolbars.length<=4">
                                                        <label class="shop_label" ng-repeat="item in vm.toolbars">
                                                            <input type="radio" name="navs" ng-model="control.config[attr.key] value="{{item.key_type}}" checked="" ng-click="vmFunc.editControlData(control,attr.key)">
                                                            <span ng-bind="item.key_type"></span>
                                                        </label>
                                                        <label class="shop_label shop_a" ng-click="vmFunc.showAddType(control,attr.key)">
                                                            <span>新增</span>
                                                        </label>
                                                    </div>
                                                    <div ng-if="control.control =='headsearch'&&vm.toolbars.length>4">
                                                        <select class="selectbox" ng-model="control.config[attr.key]" ng-options="model.key_type as model.key_type for model in vm.toolbars" ng-change="vmFunc.editControlData(control,attr.key)">
                                                        </select>
                                                        <label class="shop_label shop_a" ng-click="vmFunc.showAddType(control,attr.key)">
                                                            <span>新增</span>
                                                        </label>
                                                ...
                                                <div class="shop_choose" ng-if="attr.type==1">
                                                    <div class="radio-group" ng-repeat="item in attr.options" ng-if="attr.options.length<=4">
                                                        <label class="shop_label">
                                                            <input type="radio" name="{{'option'+control.control_id+attr.key}}" ng-if="(control.control =='search' || control.control =='headerbar' || control.control =='headsearch') && attr.key=='sidemenu_button'" ng-model="control.config[attr.key]" value="{{item.value}}" checked="" ng-click="vmFunc.addSidemenuControl(control)">
                                                            <input type="radio" name="{{'option'+control.control_id+attr.key}}" ng-if="!((control.control =='search'|| control.control =='headerbar' || control.control =='headsearch') && attr.key=='sidemenu_button')" ng-model="control.config[attr.key]" value="{{item.value}}" checked="" ng-click="vmFunc.editControlData(control)">
                                                            <span ng-bind="item.text"></span>
                                                        </label>
                                                    </div>
                                                    <select class="selectbox" ng-model="control.config[attr.key]" ng-if="(control.control =='search'|| control.control =='headerbar' || control.control =='headsearch')  && attr.key=='sidemenu_button' && attr.options.length>4" ng-options="model.value as model.text for model in attr.options" ng-change="vmFunc.addSidemenuControl(control)">
                                                    </select>
                                                    <select class="selectbox" ng-model="control.config[attr.key]" ng-if="!((control.control =='search'|| control.control =='headerbar' || control.control =='headsearch')  && attr.key=='sidemenu_button') && attr.options.length>4" ng-options="model.value as model.text for model in attr.options" ng-change="vmFunc.editControlData(control)">
                                                    </select>
                                                </div>
                                                ...
                                                <div class="shop_choose" ng-if="attr.type==5">
                                                    <zc-slider config="{{attr.slider_1}}" ng-if="(control.control =='block' && control.config.type==1)" value="control.config[attr.key]"></zc-slider>
                                                    <zc-slider config="{{attr.slider}}" ng-if="!(control.control =='block' && control.config.type==1)" value="control.config[attr.key]"></zc-slider>
                                                </div>
                                                <div class="shop_choose" ng-if="attr.type==6">
                                                    <div style="width: 90%;">
                                                        <zc-select-link s-type="control.config[attr.key+'_s_type']" s-l-type="control.config[attr.key+'_s_l_type']" s-value="control.config[attr.key+'_s_value']" s-text="control.config[attr.key+'_s_text']" s-link="control.config[attr.key]"></zc-select-link>
                                                    </div>
                                                </div>
                                                <div class="shop_choose" ng-if="attr.type==7">
                                                    <zc-shop ids="control.config[attr.key]" good-list="control.config.good_list" cates="vm.mall_cates" tags="vm.mall_tags"></zc-shop>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <table class="data-table" ng-class="{'m-top':$index>0}">
                                        <tr>
                                            <td class="data-td imgTd">
                                                ...
                                                <input type="file" name="file1" class="file slide" style="display: none;" control-id="{{control.control_id}}" attr-index="{{$index}}" attr-key="img" control-right="data" />
                                            </td>
                                            <td class="data-td">
                                                <table class="c-table">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3" style="vertical-align: middle;">
                                                            <div style="width: 90%;">
                                                                <zc-select-link s-type="slide.s_type" s-value="slide.s_value" s-text="slide.s_text" s-l-type="slide.type" s-link="slide.link" s-edit="control.is_edit"></zc-select-link>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td class="data-td">
                                                <table class="c-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <input type="radio" class="positionTop2" id="{{'rdo0_visible_set_'+control.control_id+'_'+$index }}" name="{{'visible_set_'+control.control_id+'_'+$index }}" ng-model="toolbar.visible_set" value="0" checked=""  ng-click="vmFunc.editExData(control,$index,'visible_set')" /><label for="{{'rdo0_visible_set_'+control.control_id+'_'+$index }}">所有人可见</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label-td-54">
                                                        ...
                                                        <td colspan="2">
                                                            <input type="radio" class="positionTop2" id="{{'rdo1_visible_set_'+control.control_id+'_'+$index }}" name="{{'visible_set_'+control.control_id+'_'+$index }}" ng-model="toolbar.visible_set" value="1" checked=""  ng-click="vmFunc.editExData(control,$index,'visible_set')" /><label for="{{'rdo1_visible_set_'+control.control_id+'_'+$index }}">仅分销员可见</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label-td-54">
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <%--<input type="radio" class="positionTop2" id="{{'rdo2_visible_set_'+control.control_id+'_'+$index }}" name="{{'visible_set_'+control.control_id+'_'+$index }}" ng-model="toolbar.visible_set" value="2" checked=""  ng-click="vmFunc.editExData(control,$index,'visible_set')" /><label for="{{'rdo2_visible_set_'+control.control_id+'_'+$index }}">指定权限组可见</label>--%>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr ng-if="!!control.config.nav_right_style && (control.config.nav_right_style==2 || control.config.nav_right_style==3) ">
                                                        <td class="label-td-54">
                                                            <span>右文字：</span>
                                                        </td>
                                                        <td colspan="3">
                                                            <input type="text" class="data-txt" placeholder="右文字" ng-model="toolbar.right_text" ng-blur="vmFunc.editExData(control,$index,'right_text')" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                            ...
                            <div class="form-div m-top" ng-if="control.control=='headsearch' && control.config.nav_left_type==1 && control.config.nav_left">
                                <div>
                                    左边导航：
                                </div>
                                <div class="exDataDiv" ng-repeat="nav in control.left_list">
                                    <table class="data-table" ng-class="{'m-top':$index>0}">
                                        <tr>
                                            <td class="data-td imgTd pTop10">
                                                <div class="imgDiv toolbarImgDiv" ng-show="nav.ico == ''">
                                                ...
                                                <div class="imgDiv toolbarIcoDiv" ng-show="nav.ico != ''" ng-click="vmFunc.showSelectToolbarClass(control,$index,'left_list')">
                                                    <div class="toolbarIco" ng-bind-html="nav.ico|FormatterIcon:nav.ico_color">
                                                    </div>
                                                </div>
                                                <div class="toolbarDiv">
                                                    <input type="file" name="file1" class="file toolbar" style="display: none;" control-id="{{control.control_id}}" attr-index="{{$index}}" attr-list-key="left_list" attr-key="img" control-right="data" attr-toolbar-img="1" />
                                                    <button class="button button-calm toolbarImg">上传图片</button>
                                                </div>
                                                <div class="toolbarDiv">
                                                    <button class="button button-calm" ng-click="vmFunc.showSelectToolbarClass(control,$index,'left_list')">选择图标</button>
                                                </div>
                                            </td>
                                            <td class="data-td">
                                                <table class="c-table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="data-txt" placeholder="名称" ng-model="nav.text" ng-blur="vmFunc.editExData(control,$index,'text','left_list')" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label-td-54" style="vertical-align: middle;">
                                                        ...
                                                        <td style="vertical-align: middle;">
                                                            <div style="width: 90%;">
                                                                <zc-select-link s-type="nav.s_type" s-value="nav.s_value" s-text="nav.s_text" s-link="nav.url" s-l-type="nav.type" s-edit="control.is_edit"></zc-select-link>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="data-txt color" placeholder="图标色" ng-model="nav.ico_color" control-control="{{control.control}}" control-id="{{control.control_id}}" attr-index="{{$index}}" attr-key="ico_color" ng-blur="vmFunc.editExData(control,$index,'ico_color','left_list')" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <div class="deleteExData" ng-click="vmFunc.deleteExData(control,$index,'left_list')">
                                        <img src="/img/delete.png" />
                                    </div>
                                    <div class="moveUpExData" ng-click="vmFunc.moveUpExData(control,$index,'left_list')">
                                        <img src="/img/icons/up.png" />
                                    </div>
                                    <div class="moveDownExData" ng-click="vmFunc.moveDownExData(control,$index,'left_list')">
                                        <img src="/img/icons/down.png" />
                                    </div>
                                </div>
                                <div class="deleteDiv">
                                    <button class="button button-calm" ng-click="vmFunc.addExData(control,'left_list')">添加</button>
                                </div>
                            </div>
                            <div class="form-div m-top" ng-if="control.control=='headsearch' && control.config.nav_right">
                                <div>
                                    右边导航：
                                </div>
                                <div class="exDataDiv" ng-repeat="nav in control.right_list">
                                    <table class="data-table" ng-class="{'m-top':$index>0}">
                                        <tr>
                                            <td class="data-td imgTd pTop10">
                                                <div class="imgDiv toolbarImgDiv" ng-show="nav.ico == ''">
                                                ...
                                                <div class="imgDiv toolbarIcoDiv" ng-show="nav.ico != ''" ng-click="vmFunc.showSelectToolbarClass(control,$index,'right_list')">
                                                    <div class="toolbarIco" ng-bind-html="nav.ico|FormatterIcon:nav.ico_color">
                                                    </div>
                                                </div>
                                                <div class="toolbarDiv">
                                                    <input type="file" name="file1" class="file toolbar" style="display: none;" control-id="{{control.control_id}}" attr-index="{{$index}}" attr-list-key="right_list" attr-key="img" control-right="data" attr-toolbar-img="1" />
                                                    <button class="button button-calm toolbarImg">上传图片</button>
                                                </div>
                                                <div class="toolbarDiv">
                                                    <button class="button button-calm" ng-click="vmFunc.showSelectToolbarClass(control,$index,'right_list')">选择图标</button>
                                                </div>
                                            </td>
                                            <td class="data-td">
                                                <table class="c-table">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="data-txt" placeholder="名称" ng-model="nav.text" ng-blur="vmFunc.editExData(control,$index,'text','right_list')" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label-td-54" style="vertical-align: middle;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="data-txt color" placeholder="图标色" ng-model="nav.ico_color" control-control="{{control.control}}" control-id="{{control.control_id}}" attr-index="{{$index}}" attr-key="ico_color" ng-blur="vmFunc.editExData(control,$index,'ico_color','right_list')" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <div class="deleteExData" ng-click="vmFunc.deleteExData(control,$index,'right_list')">
                                        <img src="/img/delete.png" />
                                    </div>
                                    <div class="moveUpExData" ng-click="vmFunc.moveUpExData(control,$index,'right_list')">
                                        <img src="/img/icons/up.png" />
                                    </div>
                                    <div class="moveDownExData" ng-click="vmFunc.moveDownExData(control,$index,'right_list')">
                                        <img src="/img/icons/down.png" />
                                    </div>
                                </div>
                                <div class="deleteDiv">
                                    <button class="button button-calm" ng-click="vmFunc.addExData(control,'right_list')">添加</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    //var user_type = <%= (curUser!=null && curUser.UserType == 1)?1:2%>;
    var pageConfig={};
...
<%--<script type="text/javascript" src="/Scripts/color/jscolor.js?v=20160804"></script>--%>
<script src="http://static-files.socialcrmyun.com/lib/color/spectrum/spectrum.js" type="text/javascript"></script>
<%--<script src="http://static-files.socialcrmyun.com/lib/jquery/slidereveal/1.1.1/slidereveal.js"></script>--%>
<script type="text/javascript" src="/customize/comeoncloud/m2/dist/app.bundle.js?v=2017051901"></script>
<script type="text/javascript" src="/customize/comeoncloud/m2/dist/templateCache.js?v=2017051901"></script>
<script type="text/javascript" src="/Plugins/angular/zcSlider/zcSlider.js?v=2017041202"></script>
<script type="text/javascript" src="/Plugins/angular/zcSelectLink/zcSelectLink.js?v=2017041202"></script>
<script type="text/javascript" src="/Plugins/angular/zcShop/zcShop.js?v=2017041202"></script>
<script type="text/javascript" src="/admin/component/js/edit_page.js?v=2017051901"></script>
