<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="EditByKey.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Component.EditByKey" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div class="ActivityBox" style="min-height:430px;">
        <div style="font-size: 12px; width: 700px;">
            ...
            <a href="javascript:void(0);" id="btnSave" class="button button-rounded button-primary" style="width:160px;">提交</a> 
            </div>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    <script type="text/javascript">
        ...
        var action = "update.ashx";
        var loadSltModel = false;
        var component_config = {};
        var old_component_config = {};
        ...
        var domain = '<%=!string.IsNullOrEmpty(strDomain)?strDomain+":"+Request.Url.Port:Request.Url.Authority%>';
        $(function () {
            
            $('#txtAccessLevel').val(component.AccessLevel);
            chkIsWXSeniorOAuth.checked = component.IsWXSeniorOAuth == 1?true:false;
            ...
            old_component_config = JSON.parse(component.ComponentConfig);
            loadModelData();
            bindOldData();
            jscolor.init();
            ...
            $('#btnSave').click(function () {
                try {
                    ...
                    //模型
                    var postDataModel = {
                        component_id:component.AutoId,
                        component_key:component.ComponentKey,
                        component_name: component.ComponentName,
                        component_model_id: component.ComponentModelId,
                        decription: component.Decription,
        ...
        function loadModelData() {
            now_component_model_fields = component_model.component_model_fields;
            var appendhtml = new StringBuilder();
            appendhtml.AppendFormat('<div class="config" style="width:100%;">');
            for (var i = 0; i < component_model.component_model_fields.length; i++) {
                var nfield = component_model.component_model_fields[i];
...
//                        }
        ...
        function ShowQRcode() {
            ...
            var nurl = component_model.component_model_link_url.substr(0,component_model.component_model_link_url.indexOf("?"));
            str.AppendFormat('http://{1}{0}?key={2}', nurl, domain,component.ComponentKey);
            var linkurl= str.ToString();
            $.ajax({
                type: 'post',
