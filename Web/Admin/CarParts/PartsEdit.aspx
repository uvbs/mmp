<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AngularAdmin.Master" AutoEventWireup="true" CodeBehind="PartsEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.CarParts.PartsEdit" %>
        ...
        comeonModule.controller('AddServerCtrl', ['$scope', 'commService', '$modal', 'FileUploader', 'cateService', function ($scope, commService, $modal, FileUploader, cateService) {
            ...
            pageFunc.save = function () {
                ...
                var jsonData = {
                    ...
                    carModelId: pageData.selectData.currSelectCarModel.CarModelId,
