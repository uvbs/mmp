<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Activity.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">
        当前位置：&nbsp;&nbsp;&nbsp;活动>&nbsp;&gt;&nbsp;&nbsp;<span>添加</span> <a title="返回管理" style="float: right; margin-right: 20px;" href="List.aspx" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
            ...
            <table width="100%;">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td width="*" align="left">
                        <input type="date" id="txtBeginDate"  value=""   />
                    </td>
                </tr>
                  <tr>
                    ...
                    <td width="*" align="left">
                        <input type="date" id="txtEndDate"  value="" />
                    </td>
                </tr>
                  <tr style="display:none;">
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtAddress"  value="" style="width: 100%;"  />
                    </td>
                </tr>
            ...
            <div class="items" data-item-index="0" data-item-id="" >
                ...
                <table style="width: 100%; margin-left: 10px;">
                    ...
                    <tr>
                        <td>
                          <%--  开始日期: 
                            <input type="datetime-local" class="begin-date" value="" />
                            结束日期:
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        var handlerUrl = "/serv/api/admin/meifan/activity/add.ashx";
        var editor;
        var itemCount = 1; //数量
