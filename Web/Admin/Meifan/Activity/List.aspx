<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Activity.List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;活动&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>活动管理</span>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    <script type="text/javascript">
        ...
        var handlerUrl = "/serv/api/admin/meifan/activity/";
        $(function () {
            $('#grvData').datagrid(
                   {
                       method: "Post",
