<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Match.Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">
        当前位置：&nbsp;&nbsp;&nbsp;竞赛>&nbsp;&gt;&nbsp;&nbsp;<span>编辑</span> <a title="返回管理" style="float: right; margin-right: 20px;" href="List.aspx" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        var handlerUrl = "/serv/api/admin/meifan/match/update.ashx";
        var editor;
        var itemCount = 1; //数量
