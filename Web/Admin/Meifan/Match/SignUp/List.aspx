<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Match.SignUp.List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;竞赛&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>竞赛报名管理</span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    <script type="text/javascript">
        ...
        var handlerUrl = "/serv/api/admin/meifan/match/signup/";
        var currSelectID = "";
        $(function () {
            $('#grvData').datagrid(
                   {
                       ...
                       columns: [[
                                   ...
                                   { field: 'Remark', title: '成绩单', width: 20, align: 'left' }
