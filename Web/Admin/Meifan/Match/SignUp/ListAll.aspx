<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="ListAll.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Match.SignUp.ListAll" %>
    ...
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        <div style="margin-bottom: 5px">
            ...
            <input class="easyui-datebox" id="txtFrom" />&nbsp;至
                ...
                竞赛名称:
                <input type="text" id="txtActivityName" placeholder="竞赛名称" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
            ...
            $('#grvData').datagrid(
                   {
                       ...
                       singleSelect: true,
                       columns: [[
                                   { field: 'ActivityName', title: '竞赛名称', width: 20, align: 'left' },
                                   ...
                                   {
                                       field: 'Remarks', title: '成绩单', width: 20, align: 'left', formatter: function (value, rowData) {
                ...
                buttons: [{
                    ...
                    handler: function () {
                        try {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "/serv/api/admin/meifan/match/signup/update.ashx",
                                data: dataModel,
                                dataType: "json",
                ...
                buttons: [{
                    ...
                    handler: function () {
                        try {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "/serv/api/admin/meifan/match/signup/add.ashx",
    ...
    'insertunorderedlist', '|', 'importword', 'video', 'image', 'multiimage', 'link', 'unlink', 'lineheight', '|', 'baidumap', '|', 'template', '|', 'table', 'cleardoc'],
        ...
        function loadDateList() {
            ...
            $.ajax({
                type: 'post',
                url: "/serv/api/meifan/match/get.ashx",
