<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Train.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">
        当前位置：&nbsp;&nbsp;&nbsp;培训>&nbsp;&gt;&nbsp;&nbsp;<span>添加</span> <a title="返回管理" style="float: right; margin-right: 20px;" href="List.aspx" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
        ...
        <div style="font-size: 12px; width: 100%">
            <table width="100%;">
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtMainPoints" maxlength="100" value="" style="width: 100%;" placeholder="课程要点(必填)" />
                    </td>
                </tr>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        var handlerUrl = "/serv/api/admin/meifan/train/add.ashx";
        var editor;
        var itemCount = 1; //数量
