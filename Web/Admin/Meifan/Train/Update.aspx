<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Meifan.Train.Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">
        当前位置：&nbsp;&nbsp;&nbsp;培训>&nbsp;&gt;&nbsp;&nbsp;<span>编辑</span> <a title="返回管理" style="float: right; margin-right: 20px;" href="List.aspx" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
    ...
    <div class="ActivityBox">
        <div style="font-size: 12px; width: 100%">
            <table width="100%;">
                ...
                <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">课程要点：
                    </td>
                    <td width="*" align="left">
                        <input type="text" id="txtMainPoints" maxlength="100" value="<%=activityInfo.MainPoints %>" style="width: 100%;" placeholder="课程要点(选填)" />
                    </td>
                </tr>
                <tr>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        var handlerUrl = "/serv/api/admin/meifan/train/update.ashx";
        var editor;
        var itemCount = 1; //数量
    ...
    'insertunorderedlist', '|', 'importword','video', 'image', 'multiimage', 'link', 'unlink','lineheight', '|', 'baidumap', '|', 'template', '|', 'table', 'cleardoc'],
        ...
        function loadItems() {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                appendhtml.AppendFormat('<tr>');
                appendhtml.AppendFormat('<td>');
                appendhtml.AppendFormat('开始日期:  <input type="date" class="begin-date" value="{0}"/>',items[i].FromDate);
                appendhtml.AppendFormat('结束日期: <input type="date" class="end-date" value="{0}" />',items[i].ToDate);
                appendhtml.AppendFormat('组别:');
                appendhtml.AppendFormat('<select class="group-type">');
                //appendhtml.AppendFormat('<option value="无">无</option>');
