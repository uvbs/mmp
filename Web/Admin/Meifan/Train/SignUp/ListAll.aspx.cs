...
namespace ZentCloud.JubitIMP.Web.Admin.Meifan.Train.SignUp
{
    public partial class ListAll : System.Web.UI.Page
    {
        ...
        {
            int totalCount = 0;
            ActivityList = bllMeifan.ActivityList(1, int.MaxValue, "train", "", "", out totalCount);
...
p.TagName));
            ...
            PmsAdd = bllMenupermission.CheckUserAndPmsKey(bllUser.GetCurrUserID(), BLLPermission.Enums.PermissionSysKey.PMS_MFTRAIN_ADDSIGNUP);
