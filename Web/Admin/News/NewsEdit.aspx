<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="NewsEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.News.NewsEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;<a href="NewsList.aspx">新闻资讯管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span><%=Request["id"]=="0"?"新增":"编辑" %>新闻资讯</span>
