<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="AskEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.Ask.AskEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;<a href="AskList.aspx">问题管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span><%=Request["id"]=="0"?"新增":"编辑" %>问题</span>
    <a href="AskList.aspx" style="float: right; margin-right: 20px; color: Black;" title="返回问题列表" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
</asp:Content>
    ...
    <div class="ActivityBox">
        <div style="font-size: 12px; width: 100%">
            <table id="mainTable">
                ...
                <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">分类：
                    </td>
                    <td width="*" align="left">
                        <%=sbCategory.ToString()%>
                    </td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        ...
        function init() {
            ...
            chosenBind({ id: '#ddlcategory', placeholder: '选择类型' ,width:'200px'});
        }
        ...
        function areaBind() {
            ...
            $.ajax({
                type: 'POST',
                url: '/Admin/Case/Handler/CaseHandler.ashx',
