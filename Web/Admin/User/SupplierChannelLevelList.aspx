<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="SupplierChannelLevelList.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.Admin.User.SupplierChannelLevelList" %>
...
<script type="text/javascript">
    ...
    var currSelectID = 0;
    var currAction = '';
    var levelType = "DistributionSupplierChannel";
    $(function () {
        $('#grvData').datagrid(
            {
                method: "Post",
                ...
                handler: function () {
                    try {
                        var dataModel = {
                            ...
                            ChannelRate: $("#txtRate").val(),// 供应上渠道等级
