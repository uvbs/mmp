<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="WXForwarUserInfo.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Forward.WXForwarUserInfo" %>
        ...
        <div style="margin-bottom: 5px">
            <a href="javascript:;" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-excel'"
                id="btnExportToFile" onclick="DownLoadData()">导出到文件</a>
                 <a style="float: right;" href="javascript:history.go(-1);" class="easyui-linkbutton" iconcls="icon-redo" plain="true">返回</a>
        </div>
    </div>
         ...
         $('#grvData').datagrid(
	            {
	                ...
	                columns: [[
                                ...
                                { field: 'ActivityName', title: '活动名称', width: 15, align: 'left' },
                                {
                                    field: 'ActivitySignUpCount', title: '报名人数', sortable: true, width: 8, align: 'left', formatter: function (value, rowData) {
                                        var str = new StringBuilder();
                                        if (rowData.ActivitySignUpCount == 0) {
                                            str.AppendFormat("{0}", 0);
                                        } else {
                                            str.AppendFormat('<a class="listClickNum" title="点击查看报名人数" href="/App/Cation/ActivitySignUpDataManage.aspx?ActivityID={0}&LinkName={1}" >{2}</a>', rowData.ActivityId, rowData.LinkName, rowData.ActivitySignUpCount);
                                        }
                                        return str.ToString();
                                }
                                },
                                ...
                                { field: 'RealLink', title: '链接地址', width: 23, align: 'left' },
