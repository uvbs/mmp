<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnswerRank.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Forward.wap.AnswerRank" %>
...
<head runat="server">
    ...
    <title>
           <%=ActivityName%>答题<%=website.SortType==1?"阅读量":"" %>排行榜
    </title>
    ...
    <div class="mainlist">
        <div class="tagbar">
            <a href="javascript:window.location.href=window.location.href;" class="wbtn wbtn_greenyellow">
                <span class="title">
                    <%=ActivityName%>答题<%=website.SortType==1?"阅读量":"" %>排行榜</span> </a>
        </div>
    </div>
