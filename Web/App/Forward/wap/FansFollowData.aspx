<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FansFollowData.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Forward.wap.FansFollowData" %>
...
<script type="text/javascript">
    ...
    function LoadNeed() {
        ...
        $.ajax({
            ...
            data: { Action: 'GetFansInfo', PageIndex: PageIndex, PageSize: PageSize, article_id: articleId },
            timeout: 60000,
            dataType: "json",
            success: function (resp) {
                ...
                for (var i = 0; i < resp.ExObj.length; i++) {
                    ...
                    str.AppendFormat('<h2>{0}</h2>', resp.ExObj[i].wxnickname);
