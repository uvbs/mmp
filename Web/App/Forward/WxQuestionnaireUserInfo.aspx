<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="WxQuestionnaireUserInfo.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Forward.WxQuestionnaireUserInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;微问卷&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>所有转发人信息</span>
</asp:Content>
            ...
            $('#grvData').datagrid(
                   {
                       ...
                       columns: [[
                                   ...
                                   { field: 'ActivityName', title: '问卷标题', width: 18, align: 'left' },
                                   {
                                       field: 'AnswerCount', title: '答题人数', sortable: true, width: 8, align: 'left', formatter: function (value, rowData) {
                                           var str = new StringBuilder();
                                           if (rowData.AnswerCount == 0) {
                                               str.AppendFormat("{0}", rowData.PowderCount);
                                           } else {
                                               str.AppendFormat('<a class="listClickNum" title="点击查看答题人" href="WxAnswerUserInfo.aspx?aid={0}&spreadUserId={1}" >{2}</a>', rowData.ActivityId, rowData.LinkName, rowData.AnswerCount);
                                           }
                                           return str.ToString();
                                       }
                                   },
                                   {
                                       field: 'UV', title: '微信阅读人数', sortable: true, width: 8, align: 'left', formatter: function (value, rowData) {
                                           ...
                                           if (rowData.UV == 0) {
                                               ...
                                               str.AppendFormat('<a class="listClickNum" href="/App/Monitor/EventDetails.aspx?aid={0}&uv=1&spreaduserid={1}" title="点击查看统计详情">{2}</a>', rowData.MonitorPlanID, rowData.LinkName, rowData.UV);
                                           }
                                   ...
                                   },
                                    {
                                        field: 'ippv', title: 'IP/PV', width: 8, sortable: true, align: 'left', formatter: function (value, rowData) {
                                            ...
                                            if (rowData.OpenCount == 0) {
                                                ...
                                                str.AppendFormat('<a class="listClickNum" href="/App/Monitor/EventDetails.aspx?aid={0}&spreaduserid={1}" title="点击查看统计详情">{2}/{3}</a>', rowData.MonitorPlanID, rowData.LinkName, rowData.DistinctOpenCount, rowData.OpenCount);
                                            }
                                            return str.ToString();
                                        }
                                    },
