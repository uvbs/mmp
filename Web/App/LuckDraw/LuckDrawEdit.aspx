<%@ Page Title="编辑活动投票页面" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="LuckDrawEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.LuckDraw.LuckDrawEdit" %>
        ...
        <div style="font-size: 12px; width: 100%">
            <table width="100%">
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtLotteryName" value="<%=lottery.LotteryName %>" style="width: 100%;" placeholder="抽奖活动名称(必填)" />
                    </td>
                </tr>
                ...
                <tr class="wrapImgThumbnailsPath">
                    ...
                    <td width="*" align="left">
                        <img alt="抽奖背景图片" style="width: 250px; height: 160px;" src="<%=lottery.BackGroudImg %>" accept="image/*" width="30%" id="imgThumbnailsPath" /><br />
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <div class="startfile">
                            <%
                                if (!string.IsNullOrEmpty(lottery.StartMusic))
                                {
                                    %>
                                        <div class="start"><span class="startmusicurl"><%=lottery.StartMusic %></span><img  src="/img/delete.png" alt="删除"/></div>
                                    <%
                                }     
                            %>
                        </div>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <div class="stopfile">
                             <%
                                if (!string.IsNullOrEmpty(lottery.StopMusic))
                                {
                                    %>
                                        <div class="stop"><span class="stopmusicurl"><%=lottery.StopMusic %></span><img  src="/img/delete.png" alt="删除"/></div>
                                    <%
                                }     
                            %>
                        </div>
                ...
                <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">主题背景颜色：
                    </td>
                    <td width="*" align="left">
                        <div class="rows">
                            <div class="col-xs-12">
                                <input type="text" class="color" id="bgcolor" value="<%=lottery.BackGroundColor %>" /><span class="lbTip" data-tip-msg="<b>主题颜色说明</b><br>1.同步抽奖页面的标题背景颜色<br>2.同步抽奖页面的按钮背景颜色">?</span>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="*" align="left">
                        <div class="rows">
                            <div class="col-xs-12">
                                <input type="text" class="color" id="fontcolor" value="<%=lottery.TitleFontColor %>" /><span class="lbTip" data-tip-msg="<b>主题颜色说明</b><br>1.同步抽奖页面的标题背景颜色<br>2.同步抽奖页面的按钮背景颜色">?</span>
                            </div>
                        </div>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <div class="rows">
                            <div class="col-xs-12">
                                <input type="text" class="color" id="userbgcolor" value="<%=lottery.UserBackGroudColor%>" /><span class="lbTip" data-tip-msg="<b>说明</b><br>1.同步抽奖页面正在转动框的背景颜色<br>">?</span>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="number" class="form-control" id="txtOneWinnerCount" value="<%=lottery.OneWinnerCount %>" placeholder="(必填)" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">是否显示中奖名单：
                    </td>
                    <td width="*" align="left">
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <div>
                            ...
                            <input type="radio" value="1" class="positionTop2" name="qrcode" id="hcode" /><label for="hcode">隐藏</label>
                        </div>
                        <div>
                        ...
                        <div class="showdistributor">
                            ...
                            <span  id="disUserId"><%=lottery.DistributorUserId%></span>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="radio" value="0" class="positionTop2" name="title" id="stitle" /><label for="stitle">显示</label>
                        <input type="radio" value="1" checked="checked" class="positionTop2" name="title" id="htitle" /><label for="htitle">隐藏</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        var handlerUrl = "/serv/api/admin/lottery/LuckDraw/edit.ashx";
        var editor;
        var lotteryId = '<%=lottery.LotteryID%>';
        var status = '<%=lottery.Status%>';
        var ishidewinning = '<%=lottery.IsHideWinningList%>';
        var qrcode = '<%=lottery.IsHideQRCode%>';
        var title = '<%=lottery.IsHideTitle%>';
        var isqrcode = '<%=lottery.QRCode%>';
        var disUserId = '<%=lottery.DistributorUserId%>';
        ...
        $(function () {
            ...
            $('#btnReset').click(function () {
                ...
                $("input[name=qrcode][value=0]").attr("checked", true);
                $("input[name=title][value=1]").attr("checked", true);
                $("input[name=yellow][value=1]").attr("checked", true);
                $('.bgcolor').val('');
                $('#bgcolor').val('');
                $('#fontcolor').val('');
                $('#userbgcolor').val('');
