<%@ Page Title="" Language="C#" MasterPageFile="~/App/Cation/Wap/Vote/Comm/Master.Master"
    AutoEventWireup="true" CodeBehind="MySignUp.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Cation.Wap.Vote.Comm.MySignUp" %>
            ...
            <div class="form ">
                ...
                <div class="form_div radius4">
                    <table>
                        <tr>
                            <td valign="top">
                                <span class="form_span">身高</span>
                            </td>
                            <td>
                                <input type="number" id="txtHeight" name="height" value="<%=model.Height %>" placeholder="输入你的身高"
                                    class="form_input" />
                            </td>
                        </tr>
                    </table>
                ...
                <div class="form_div radius4">
                    <table>
                        <tr>
                            <td valign="top">
                                <span class="form_span"><%=string.IsNullOrWhiteSpace(currVote.SignUpDeclarationRename)? "参赛宣言": currVote.SignUpDeclarationRename%></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" name="moblie" id="txtIntroduction" value="<%=model.Introduction %>"
                                    placeholder="输入你的<%=string.IsNullOrWhiteSpace(currVote.SignUpDeclarationRename)? "参赛宣言": currVote.SignUpDeclarationRename%>" class="form_input" />
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td>
                                <div class="signup_msg">
                                    请<span>点击头像图片或者加号</span>上传<span>本人自拍照3-5张</span>，其中<span>1张自拍须手持写有“<%=currVote.HandheldWords %>”字样的纸张</span>，请注意照片附件大小在1MB以内。</div>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
           ...
           if (status==1) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.errcode == 0) {
                        layermsg("个人资料更新成功！");
                         setTimeout("window.location = 'MySignUp.aspx?vid=<%=currVote.AutoID%>'", 2000);
