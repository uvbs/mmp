...
{
    public partial class ActivityStatistics : System.Web.UI.Page
    {
        BLLJIMP.BLLJuActivity juBll;
        public BLLJIMP.Model.JuActivityInfo juActivityModel = new BLLJIMP.Model.JuActivityInfo();
        public BLLJIMP.Model.UserInfo userModel;
        public List<BLLJIMP.Model.ActivityDataInfo> signUpDataList;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.userModel.UserType != 1)
            {
                ...
                {
                    Response.Write("<script>alert('无权访问该活动!');</script>");
                    Response.End();
                    return;
                }
            }
