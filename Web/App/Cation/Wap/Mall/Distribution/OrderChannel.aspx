<%@ Page Title="" Language="C#" MasterPageFile="~/App/Cation/Wap/Mall/Distribution/Distribution.Master" AutoEventWireup="true" CodeBehind="OrderChannel.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Cation.Wap.Mall.Distribution.OrderChannel" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="topbar">
        <a class="col-xs-4 categorylink current">会员订单</a>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            var ajaxData = {
                Action: 'QueryMyOrderChannel',
                Status: GetParm("status"),
                AutoId: GetParm("autoid"),
                pageIndex: pageIndex,
                pageSize: pageSize
            }
            $("#btnNext").text("加载中...");
