<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseList.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.WanBang.Wap.BaseList" %>
...
<html lang="zh-CN">
	...
	<body>
      ...
      <input type="text" id="txtName" class="company" placeholder="基地名称"/>
     ...
     <script type="text/javascript">
         ...
         function LoadList() {
             $.ajax({
                 ...
                 data: { Action: 'GetBaseList', Area: $("#ddlArea").val(), BaseName: $("#txtName").val(), PageIndex: PageIndex, PageSize: PageSize },
                 timeout: 60000,
                 dataType: "json",
