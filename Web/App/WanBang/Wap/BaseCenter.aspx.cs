...
{
    public partial class BaseCenter : System.Web.UI.Page
    {
        /// <summary>
        ///基地资料
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            model = new BLLJIMP.BLL("").Get<WBBaseInfo>(string.Format("UserId='{0}'", HttpContext.Current.Session[SessionKey.WanBangUserID].ToString()));
