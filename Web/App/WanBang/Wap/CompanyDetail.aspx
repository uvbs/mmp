<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDetail.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.WanBang.Wap.CompanyDetail" %>
...
<body>
        	...
        	<form class="login" method="post" action="Login.aspx?redirecturl=/App/WanBang/Wap/CompanyDetail.aspx?id=<%=model.AutoID%>">
            ...
            <div class="company-box">
                <dl class="company">
                    ...
                    <dd> 
                        ...
                        <p>
                        所属区：<%=model.Area %><br>
                        营业执照号码：<%=model.BusinessLicenseNumber %><br/>
                        负责人：<%=model.Contacts%> <br/>
    ...
    function CancelAttention() {
        ...
        if (confirm("确定取消关注?")) {
            $.ajax({
                type: 'post',
                url: handlerurl,
                data: { Action: 'CancelAttention', AutoID: "<%=model.AutoID%>", Attentiontype:1},
                timeout: 60000,
                dataType: "json",
                success: function (resp) {
                    if (resp.Status == 1) {
