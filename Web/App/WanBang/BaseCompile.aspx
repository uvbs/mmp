<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="BaseCompile.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.WanBang.BaseCompile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;<a href="BaseMgr.aspx">基地管理</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span><%=actionStr %><%if (webAction == "edit") { Response.Write("：" + model.BaseName); } %></span>
    <a href="BaseMgr.aspx" style="float:right;margin-right:20px;color:Black;" title="返回基地列表" class="easyui-linkbutton" iconcls="icon-back" plain="true" >
            返回</a>
</asp:Content>
            ...
            <table width="100%">
               ...
               <option value="崇明县">崇明县</option>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <img alt="缩略图"  src="<%=string.IsNullOrEmpty(model.Thumbnails)?"/App/WanBang/Images/baselogo.jpg":model.Thumbnails%>" width="80px" height="80px" id="imgThumbnailsPath" /><br />
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtAddress" class="" style="width: 100%;"  placeholder="基地地址" value="<%=model.Address%>"  />
                    </td>
                </tr>
                 <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtAcreage" class="" style="width: 100%;"  placeholder="基地面积" value="<%=model.Acreage%>"  />
                    </td>
                </tr>
                 <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtHelpCount" class="" style="width: 100%;"  placeholder="援助对象人数" value="<%=model.HelpCount.ToString()%>"  />
                    </td>
                </tr>
...
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
 <script type="text/javascript">
                 ...
                 var model =
                    {
                        ...
                        Action: currAction == 'add' ? 'AddBaseInfo' : 'EditBaseInfo',
     ...
     function GetRandomHb() {
         imgThumbnailsPath.src = "/App/WanBang/Images/baselogo.jpg";
     }
