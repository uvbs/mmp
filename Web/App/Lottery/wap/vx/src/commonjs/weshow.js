...
WeShow.prototype.animationOutClass=function(container,classname,callback){
	var animateclass=classname;
	// console.log("bbb");
	//动画开始
	container.addClass(animateclass);
	//动画结束
	var picanimateend=function(){
		container[0].removeEventListener("webkitAnimationEnd",picanimateend,false);
		//console.log("picanimate1end");
		//停止动画，停留在最后一帧
		container.removeClass(animateclass);
		if(typeof callback =="function") callback();
	}
	container[0].addEventListener("webkitAnimationEnd",picanimateend,false);	
}
