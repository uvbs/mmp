<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true"
    CodeBehind="SlideMgr.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.MallManage.SlideMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    当前位置：&nbsp;首页<span>Banner管理</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        <div style="margin-bottom: 5px">
            <a href="SlideAddEdit.aspx" class="easyui-linkbutton" iconcls="icon-add2" plain="true"
                id="btnAdd">添加Banner</a> <a href="javascript:;" class="easyui-linkbutton" iconcls="icon-delete"
