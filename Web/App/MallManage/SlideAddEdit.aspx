<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="SlideAddEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.MallManage.SlideAddEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">当前位置：&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="SlideMgr.aspx" title="返回Banner管理" >Banner管理</a>&gt;&nbsp;<span><%=HeadTitle%></span>
    <a href="SlideMgr.aspx" style="float: right; margin-right: 20px;" title="返回Banner管理"
            ...
            <table width="100%">
              <tr>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                    <select id="ddlType">
                    <option value="0">首页轮播图片</option>
                    <option value="1">ICON</option>
                    <option value="2">首页Banner</option>
