<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="SlideAddEditV2.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.MallManage.SlideAddEditV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">当前位置：&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="SlideMgrV2.aspx" title="返回" >Banner管理</a>&gt;&nbsp;<span><%=HeadTitle%></span>
    <a href="SlideMgrV2.aspx" style="float: right; margin-right: 20px;" title="返回"
        ...
        <div style="font-size: 12px; width: 100%">
            <table width="100%">
              <tr>
                    ...
                    <td width="*" align="left">
                    <input type="text"  id="txtLinkText" value="<%=model.LinkText%>" />
                    </td>
                </tr>
                   <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                    <select id="ddlType">
                    <option value="slide1">滑动图片1</option>
                    <option value="slide2">滑动图片2</option>
                    <option value="slide3">滑动图片3</option>
                    <option value="slide4">滑动图片4</option>
                    <option value="promotion">限时特卖</option>
                    <option value="pagetop1">顶部广告1</option>
                    </select>
                    </td>
                </tr>
                <tr>
                ...
                try {
                    ...
                    $.ajax({
                        ...
                        success: function (resp) {
                            ...
                            if (resp.Status == 1) {
                                Alert(resp.Msg);
                                window.location.href = "SlideMgrV2.aspx";
                            }
                            else {
                                Alert(resp.Msg);
                            }
