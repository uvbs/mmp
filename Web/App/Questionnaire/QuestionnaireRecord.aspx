<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="QuestionnaireRecord.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Questionnaire.QuestionnaireRecord" %>
...
<%ZentCloud.BLLJIMP.BLL bllBase = new ZentCloud.BLLJIMP.BLL();
  ZentCloud.BLLJIMP.Model.Questionnaire model = bllBase.Get<ZentCloud.BLLJIMP.Model.Questionnaire>(string.Format("QuestionnaireID={0}",Request["id"]));
    %>
     当前位置：&nbsp;&nbsp;<%=model.QuestionnaireName%>&nbsp;&gt;&nbsp;&nbsp;<span>提交记录 </span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderCnt" runat="server">
    <div id="toolbar" class="pageTopBtnBg" style="padding: 5px; height: auto;">
        ...
        <a title="返回问卷列表" style="float:right;margin-right:10px;" href="QuestionnaireMgr.aspx?type=<%=type %>" class="easyui-linkbutton" iconcls="icon-back" plain="true" >返回</a>
        </div>
    </div>
         ...
         $('#grvData').datagrid(
	            {
	                ...
	                columns: [[
                                ...
                                { field: 'op', title: '操作', width: 15, align: 'left', formatter: function (value, rowData) {
                                    var str = new StringBuilder();
                                    str.AppendFormat('<a title="查看详细" href="QuestionnaireRecordDetail.aspx?id={0}&uid={1}&type='+type+'">查看详细</a>', rowData.QuestionnaireID,rowData.UserId);
                                    return str.ToString();
                                } 
                                }
