<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="QuestionnaireCompile.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Questionnaire.QuestionnaireCompile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWebMap" runat="server">
    <div class="title">
        当前位置：&nbsp;<%=typeName %>&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;<span>发布新<%=typeName %></span> <a title="返回<%=typeName %>管理" style="float: right; margin-right: 20px;" href="/App/Questionnaire/QuestionnaireMgr.aspx?type=<%=type %>" class="easyui-linkbutton" iconcls="icon-back" plain="true">返回</a>
        ...
        <div style="font-size: 12px; width: 100%">
            <table width="100%;">
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireName" value="" style="width: 100%;" placeholder="<%=typeName %>名称(必填)" />
                    </td>
                </tr>
                <%if (type == "1")
                  { %>
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireSummary" value="" style="width: 100%;" placeholder="<%= type=="1"?"微信分享":"" %>描述(选填)" />
                ...
                <tr>
                    ...
                    <td width="*" align="left">
                        <%-- <input type="text" id="txtStopDate" value="<%=DateTime.Now.AddMonths(1).ToString("yyyy-MM-dd HH:mm:ss")%>" />--%>
                ...
                <tr>
                  ...
                  <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">问卷提交后跳转：
                    </td>
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireSubmitUrl" value="" style="width:100%;" />
                    </td>
                </tr>
                  <tr>
                    <td style="width: 100px;" align="right" class="tdTitle">问卷重复提交跳转：
                    </td>
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireRepeatSubmitUrl" value="" style="width:100%;" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtEachPageNum" value="0"  style="width:100%;"/><span style="color: red;">题目数为0时不进行分页</span>
                    </td>
                </tr>
                <tr>
            ...
            <div class="question" data-question-index="0">
                ...
                <table style="width: 100%; margin-left: 10px;">
                    <tr class="trquestionname">
                        ...
                        <td><input type="text" name="questionname" placeholder="问题(必填)" /></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" class="positionTop2" name="rdtype0" value="2" id="rd02" /><label for="rd02">填空</label>
                    ...
                    <% }%>
                    <tr>
                        <td data-answer-index="0">选项:
                            <%if (type == "0")
                              { %>
                            <input id="rdCorrect00" class="positionTop2" style="margin-left: 10px;" type="radio" name="rdCorrect0" /><label id="lblrd00" for="rdCorrect00">正确</label><input id="ckCorrect00" class="positionTop2" style="margin-left: 10px; display: none;" type="checkbox" name="ckCorrect0" /><label id="lblck00" style="display: none;" for="ckCorrect00">正确</label>
                            <%} %>
                        </td>
                        <td>
                            <input type="text" name="answer" placeholder="选项名称" /><img src="/img/delete.png" width="20" height="20" alt="删除选项" class="deleteanswer" /></td>
                    </tr>
                    <tr>
                        <td data-answer-index="1">选项:
                            <%if (type == "0")
                              { %>
                            <input id="rdCorrect01" class="positionTop2" style="margin-left: 10px;" type="radio" name="rdCorrect0" /><label id="lblrd01" for="rdCorrect01">正确</label><input id="ckCorrect01" class="positionTop2" style="margin-left: 10px; display: none;" type="checkbox" name="ckCorrect0" /><label id="lblck01" style="display: none;" for="ckCorrect01">正确</label>
                            <%} %>
                        </td>
                        <td>
                            <input type="text" name="answer" placeholder="选项名称" /><img src="/img/delete.png" width="20" height="20" alt="删除选项" class="deleteanswer" /></td>
                    ...
                    <tr>
                        <td data-answer-index="2">选项:
                            <%if (type == "0")
                              { %>
                            <input id="rdCorrect02" class="positionTop2" style="margin-left: 10px;" type="radio" name="rdCorrect0" /><label id="lblrd02" for="rdCorrect02">正确</label><input id="ckCorrect02" class="positionTop2" style="margin-left: 10px; display: none;" type="checkbox" name="ckCorrect0" /><label id="lblck02" style="display: none;" for="ckCorrect02">正确</label>
                            <%} %>                        
                        </td>
                        <td>
                            <input type="text" name="answer" placeholder="选项名称" /><img src="/img/delete.png" width="20" height="20" alt="删除选项" class="deleteanswer" /></td>
            ...
            <div style="border-top: 1px solid #DDDDDD; position: fixed; bottom: 0px; height: 52px; line-height: 55px; text-align: center; width: 100%; background-color: rgb(245, 245, 245); padding-top: 10px;">
                <a href="javascript:;" id="btnSave" class="button button-rounded button-primary" style="width: 200px;">发布<%=typeName %></a>
            </div>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="bottom" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(checkresult) {
            ...
            Questionnaire.QuestionnaireSubmitUrl = $.trim($('#txtQuestionnaireSubmitUrl').val());
            Questionnaire.QuestionnaireRepeatSubmitUrl = $.trim($('#txtQuestionnaireRepeatSubmitUrl').val());
            if ($("#txtAddScore").length > 0) {
