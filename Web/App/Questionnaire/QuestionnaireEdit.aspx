<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WebMainContent.Master" AutoEventWireup="true" CodeBehind="QuestionnaireEdit.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Questionnaire.QuestionnaireEdit" %>
            ...
            <table width="100%;">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireSubmitUrl"  value="<%=model.QuestionnaireSubmitUrl %>" style="width:100%;" />
                    </td>
                </tr>
                  <tr>
                    ...
                    <td width="*" align="left">
                        <input type="text" id="txtQuestionnaireRepeatSubmitUrl" value="<%=model.QuestionnaireRepeatSubmitUrl %>" style="width:100%;" />
                    </td>
                </tr>
                <tr>
