<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Member.Wap.Register" %>
...
<body>
    ...
    <div class="itemDiv">
        ...
        <label class="item item-input">
            ...
            <input type="text" class="name" placeholder="昵称" value="" />
        </label>
        <label class="item item-input">
            <i class="icon icon-lock iconfont"></i>
    ...
    <div class="itemDiv">
        ...
        <a style="color:#0c63ee; float:right;"  href="ForgetPassword.aspx?redirect=<%= HttpUtility.UrlEncode(Request["redirect"]) %>">忘记密码？</a>
    </div>
</body>
</html>
<script type="text/javascript">
    ...
    function getSMSCode() {
        ...
        $.ajax({
            ...
            data: { phone: phone, check_user: 1, limit_user: 2 },
    ...
    function postCode() {
        ...
        $.ajax({
            type: 'POST',
            url: handerUrl + "RegisterByPhone.ashx",
            data: { username: phone, smsvercode: code, nickname: name, password: password, passwordconfirm: confirmpassword },
            success: function (result) {
                layer.close(nlayerprogress);
                alert(result.errmsg);
                if (result.isSuccess) {
