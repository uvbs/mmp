<%@ Page Language="C#" AutoEventWireup="true" EnableSessionState="ReadOnly" CodeBehind="CompleteUserInfo.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.Member.Wap.CompleteUserInfo" %>
...
<script type="text/javascript">
    ...
    function postCode() {
        ...
        $.ajax({
            type: 'POST',
            url: handerUrl + "PostCompleteUserInfo.ashx",
            data: model,
            success: function (result) {
                layer.close(nlayerprogress);
                if (result.status) {
