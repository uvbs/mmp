<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WeuiMaster.Master" AutoEventWireup="true" CodeBehind="UseRecord.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.SVCard.Wap.UseRecord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="wrapDetail">
        ...
        <div class="weui-cells">
            <%foreach (var item in UseRecordList)
              { %>
                          <div class="weui-cell">
                ...
                <div class="weui-cell__ft"><%=((DateTime)item.UseDate).ToString("yyyy/MM/dd") %></div>
            </div>
                  
              <%}
                  if (UseRecordList.Count==0)
                  {
                      Response.Write("暂无使用记录");
                  }
