<%@ Page Title="" Language="C#" MasterPageFile="~/Master/WeuiMaster.Master" AutoEventWireup="true" CodeBehind="UseQrCode.aspx.cs" Inherits="ZentCloud.JubitIMP.Web.App.SVCard.Wap.UseQrCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="vueEl">
        ...
        <div v-show="isShow"> <img  v-bind:src="imgSrc" alt="加载中..."/>
            <div class="text">请让店员扫描此二维码</div>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="bottom" runat="server">
    <script src="js/UseQrCode.js"></script>
</asp:Content>
