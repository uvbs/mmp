...
namespace ZentCloud.ZCDALEngine
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        /// <param name="tableName">DataSet结果中的表名</param>
        /// <returns>DataSet</returns>
        public static DataSet ExecProcedure(string storedProcName, IDataParameter[] parameters, string tableName, out int totalCount)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();
                ...
                sqlDA.SelectCommand = BuildQueryCommand(connection, storedProcName, parameters);
                sqlDA.Fill(dataSet, tableName);
                totalCount = (int)sqlDA.SelectCommand.Parameters["@recordTotal"].Value;
                connection.Close();
                return dataSet;
            }
        ...
        /// 批量更新数据
        /// </summary>
        /// <param name="table">更新表</param>
        /// <param name="setPms">更新数据</param>
        /// <param name="strWhere">更新条件</param>
        /// <returns></returns>
        public static int Update(string table, string setPms, string strWhere)
        {
            ...
            ToLog("Update:" + sb.ToString());

            int result = ExecuteSql(sb.ToString());

            ToLog("Update result:" + result);
        ...
        /// 批量删除数据
        /// </summary>
        /// <param name="table">删除表</param>
        /// <param name="strWhere">删除条件</param>
        /// <returns></returns>
        public static int Delete(string table, string strWhere)
        {
            StringBuilder sb = new StringBuilder();
        ...
        public static void ToLog(string message)
        {
            ...
            //using (StreamWriter sw = new StreamWriter("D:\\DALlog.txt", true, Encoding.UTF8))
            //{
